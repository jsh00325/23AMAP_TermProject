...
public class Photo_sign extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sign_phto_activity);
        ...
        camera.setOnClickListener(view -> {
            ...
            if (intent.resolveActivity(getPackageManager()) != null) {
                ...
                Toast.makeText(Photo_sign.this, "사진을 찍을 수 있는 앱이 설치되어 있지 않습니다.", Toast.LENGTH_SHORT).show();
            }
        });
                        ...
                        if (userId != null) {
                            mDb.collection("users").document(userId)
                                    ...
                                    .addOnSuccessListener(aVoid -> {
                                        Toast.makeText(Photo_sign.this, "이메일 인증으로 회원가입을 완료하세요.", Toast.LENGTH_SHORT).show();

                                        // LoginActivity로 이동
                                        Intent intent = new Intent(Photo_sign.this, LoginActivity.class);
                                        startActivity(intent);
                                    })
                                    .addOnFailureListener(e -> {
                                        Toast.makeText(Photo_sign.this, "이미지 등록 실패", Toast.LENGTH_SHORT).show();
                                        e.printStackTrace();
                                    });
                        }
                    });
                }).addOnFailureListener(e -> {
                    Toast.makeText(Photo_sign.this, "이미지 업로드 실패", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                });
            }
            //check
